...
pVal <- ifelse(uniTab$pvalue<0.001, "<0.001", sprintf("%.3f", as.numeric(uniTab$pvalue)))
...
Hazard.ratio <- paste0(hr,"(",hrLow,"-",hrHigh,")")
pVal <- ifelse(multiTab$pvalue<0.001, "<0.001", sprintf("%.3f", as.numeric(multiTab$pvalue)))
